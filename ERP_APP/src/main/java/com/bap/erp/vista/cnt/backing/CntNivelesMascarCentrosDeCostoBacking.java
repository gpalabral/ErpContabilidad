...
@ManagedBean(name = "cntNivelesMascarCentrosDeCostoBacking")
@ViewScoped
public class CntNivelesMascarCentrosDeCostoBacking extends AbstractManagedBean implements Serializable {
    ...
    private int tamanioNumerosList[] = {1,2, 3, 4};
    private int nivel = 0;
    ...
    private String gruposNivelCombo = EnumGruposNivel.CENTROS_COSTOS.getCodigo();
    ///// codigo nuevo
    ...
    private Boolean habilitaSeleccionDeCentroCostos = true;

    public CntNivelesMascarCentrosDeCostoBacking() {
    }

    @PostConstruct
    void initCntNivelesMascarCentrosDeCostoBacking() {
        ...
        selectedNiveles = new CntNivel();
        if (!cntMascarasService.verificaExistenciaDeMascara("CCOS")) {
            habilitaSeleccionDeCentroCostos = false;
            numeroObjetosNivel = (cntNivelesService.listaDeNivelesPlanCuentas("CCOS")).size();
            auxCntNivelesList = cntNivelesService.listaDeNivelesPlanCuentas("CCOS");
            generacionMascara = cntNivelesService.muestraMascaraPlanCuentas("CCOS");
        }
    ...
    public Boolean getHabilitaSeleccionDeCentroCostos() {
        return habilitaSeleccionDeCentroCostos;
    }

    public void setHabilitaSeleccionDeCentroCostos(Boolean habilitaSeleccionDeCentroCostos) {
        this.habilitaSeleccionDeCentroCostos = habilitaSeleccionDeCentroCostos;
    }
}
