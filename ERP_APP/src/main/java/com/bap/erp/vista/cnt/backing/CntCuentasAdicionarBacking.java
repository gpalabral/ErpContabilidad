...
@ManagedBean(name = "cntCuentasAdicionarBacking")
@ViewScoped
public class CntCuentasAdicionarBacking extends AbstractManagedBean implements Serializable {
    ...
    private String nivelIn = new String();
    private String subNivelIn = new String();
    ...
    private Boolean deshabilitaCentrocostoSegundoNivel;
    private Boolean cambiaColorCuadroTextoCuentaNivel;
    private Boolean cambiaColorCuadroTextoCuentaSubNivel;
    private Boolean desactivaNivel;
    private Boolean desactivaSubNivel;
    private Boolean habilitaCentroDeCostoNivel3 = false;

    public CntCuentasAdicionarBacking() {
    }

    @PostConstruct
    void initCntCuentasAdicionarBacking() {
        try {
            if (super.getFromSessionIdEntidad() != null) {
                ...
                if (selectedEntidad.getNivel() == 3) {
                    habilitaCentroDeCostoNivel3 = true;
                    tieneCentroDeCostoNivel3 = parParametricasService.estaHabilitadoCCenDatosDeEmpresa();
                    tieneCCMasivo = false;
                }
                if (selectedEntidad.getNivel() == 2) {
                    botonCentroDeCostoHabilita = true;
                    centroDeCostoHabilita = selectedEntidad.getHabilitaCentroCosto().equals(EnumTieneCentroDeCosto.SI.getCodigo());
                    deshabilitaCentrocostoSegundoNivel = false;
                }
                if (selectedEntidad.getNivel() == 1) {
                    deshabilitaCentrocostoSegundoNivel = ((CntEntidad) getCntEntidadesService().find(CntEntidad.class, selectedEntidad.getIdEntidadPadre())).getHabilitaCentroCosto().equals(EnumTieneCentroDeCosto.SI.getCodigo());
//                    botonCentroDeCostoHabilita = !((CntEntidad) getCntEntidadesService().find(CntEntidad.class, selectedEntidad.getIdEntidadPadre())).getHabilitaCentroCosto().equals(EnumTieneCentroDeCosto.SI.getCodigo());
                    botonCentroDeCostoHabilita = !((CntEntidad) getCntEntidadesService().find(CntEntidad.class, ((CntEntidad) getCntEntidadesService().find(CntEntidad.class, selectedEntidad.getIdEntidadPadre())).getIdEntidadPadre())).getHabilitaCentroCosto().equals(EnumTieneCentroDeCosto.SI.getCodigo());
                    centroDeCostoHabilita = ((CntEntidad) getCntEntidadesService().find(CntEntidad.class, selectedEntidad.getIdEntidadPadre())).getHabilitaCentroCosto().equals(EnumTieneCentroDeCosto.SI.getCodigo());
                    botonIrACentroDeCosto = !((CntEntidad) getCntEntidadesService().find(CntEntidad.class, selectedEntidad.getIdEntidadPadre())).getHabilitaCentroCosto().equals(EnumTieneCentroDeCosto.SI.getCodigo());
    ...
    public void cargaDatosParaNivelAndSubNivel() {
        ...
        desactivaNivel = nivelIn.equals("off");
        mascaraNivel = getCntEntidadesService().generaCodigoNivelesSubAndPadre(selectedEntidad, "N");
        mensajeVerifica1 = desactivaNivel ? "Codigo Fuera de Rango" : getCntEntidadesService().verificaExistenciaCodigo(mascaraNivelPosicionUno + nivelIn + mascaraNivelPosicionDos);
        ...
        if (selectedEntidad.getNivel() == 1) {
            ...
            desactivaSubNivel = subNivelIn.equals("off");
            mascaraSubNivel = getCntEntidadesService().generaCodigoNivelesSubAndPadre(selectedEntidad, "S");
            mensajeVerifica2 = desactivaSubNivel ? "Codigo Fuera de Rango" : getCntEntidadesService().verificaExistenciaCodigo(mascaraSubNivelPosicionUno + subNivelIn + mascaraSubNivelPosicionDos);
        }
    ...
    public String saveCntEntidad_action() throws Exception {
        ...
        cntEntidad.setParametrosIndividuales(EnumConfirmacion.NO.getCodigo());
        ...
        if (cntEntidad.getNivel() == 3) {
            ...
            cntEntidad.setHabilitaCentroCosto(tieneCCMasivo ? "S" : "N");
        } else {
            if (cntEntidad.getNivel() == 2) {
                if (mascaraNuevoOpcion.equals("N")) {
                    cntEntidad.setHabilitaCentroCosto(selectedEntidad.getHabilitaCentroCosto());

                } else {
                    cntEntidad.setHabilitaCentroCosto(cntEntidadesService.find(CntEntidad.class, selectedEntidad.getIdEntidad()).getHabilitaCentroCosto().equals(EnumTieneCentroDeCosto.SI.getCodigo()) ? "S" : "N");
                }
                cntEntidad.setTieneCentroCosto(EnumTieneCentroDeCosto.NO.getCodigo());
            } else {
                if (cntEntidad.getNivel() == 1) {

                    if (cntEntidadesService.find(CntEntidad.class, selectedEntidad.getIdEntidad()).getHabilitaCentroCosto().equals(EnumTieneCentroDeCosto.SI.getCodigo())) {
                        cntEntidad.setHabilitaCentroCosto(EnumTieneCentroDeCosto.SI.getCodigo());
//                        cntEntidad.setTieneCentroCosto(centroDeCostoHabilita ? "S" : "N");
                    } else {
//                        cntEntidad.setTieneCentroCosto(EnumTieneCentroDeCosto.NO.getCodigo());
                        cntEntidad.setHabilitaCentroCosto(EnumTieneCentroDeCosto.NO.getCodigo());
                    }
        ...
        if (verificaNivelYSubNivelVacios()) {
            if (cntEntidadesService.verificaExistenciaMascara(cntEntidad)) {
                ...
                MessageUtils.addErrorMessage("La cuenta " + mascaraNuevo + " ya existe");
            }
        } else {
            if (mascaraNuevoOpcion.equals("N")) {
                cambiaColorCuadroTextoCuentaNivel = true;
                cambiaColorCuadroTextoCuentaSubNivel = false;
                MessageUtils.addErrorMessage("La cuenta Nivel debe tener un valor distinto a vacio.");
            } else {
                cambiaColorCuadroTextoCuentaNivel = false;
                cambiaColorCuadroTextoCuentaSubNivel = true;
                MessageUtils.addErrorMessage("La cuenta Sub Nivel debe tener un valor distinto a vacio.");
            }
        }
        return null;
    }

    public Boolean verificaNivelYSubNivelVacios() {
        if (mascaraNuevoOpcion.equals("N")) {
            return !nivelIn.isEmpty();
        } else {
            return !subNivelIn.isEmpty();
        }
    }
    ...
    public List<CntEntidad> listadoDePadres() {
    ...
    public String deleteCntObjetos_action() {
        MessageUtils.addInfoMessage("Aun está en construcción...Gracias por su comprensión.");
        return null;
    }
    ...
    public void generaPruebaNivel(ValueChangeEvent e) {
        ...
        muestraDialogo = descripcion.isEmpty() || desactivaNivel || nivelIn.isEmpty() || Integer.parseInt(nivelIn) == 0;
    }
    ...
    public void generaPruebaSubNivel(ValueChangeEvent e) {
        try {
            ...
            muestraDialogo = descripcion.isEmpty() || desactivaSubNivel || subNivelIn.isEmpty() || Integer.parseInt(subNivelIn) == 0;
    ...
    public void activaCombillo(ValueChangeEvent e) throws Exception {
        ...
        if (selectedEntidad.getNivel() == 2 && mascaraNuevoOpcion.equals("S")) {
            deshabilitaCentrocostoSegundoNivel = true;
            swParAutomatico = true;
            swRadioSubNivel = true;
            cntParametroAutomaticoDeNivel2 = cntParametroAutomaticoService.obtieneObjetoDeParametroAutomatico(selectedEntidad);
            cargaDatosDeParametrosAutomaticosDeNivel2();
        ...
        if (nivelNuevoPlanCuenta == 3) {
            ...
            if (nivelNuevoPlanCuenta == 2) {
                ...
                if (nivelNuevoPlanCuenta == 1) {
                    ...
                    centroDeCostoHabilita = selectedEntidad.getHabilitaCentroCosto().equals(EnumTieneCentroDeCosto.SI.getCodigo());
                    botonIrACentroDeCosto = !selectedEntidad.getHabilitaCentroCosto().equals(EnumTieneCentroDeCosto.SI.getCodigo());
                    deshabilitaCentrocostoSegundoNivel = ((CntEntidad) getCntEntidadesService().find(CntEntidad.class, selectedEntidad.getIdEntidadPadre())).getHabilitaCentroCosto().equals(EnumTieneCentroDeCosto.SI.getCodigo());
                } else {
                    botonCentroDeCostoHabilita = true;
                }
...
//    }
    public String insertaPuntosAutomaticos(CntEntidad cntEntidad) {
    ...
    public Boolean getDeshabilitaCentrocostoSegundoNivel() {
        return deshabilitaCentrocostoSegundoNivel;
    }

    public void setDeshabilitaCentrocostoSegundoNivel(Boolean deshabilitaCentrocostoSegundoNivel) {
        this.deshabilitaCentrocostoSegundoNivel = deshabilitaCentrocostoSegundoNivel;
    }

    public Boolean getCambiaColorCuadroTextoCuentaNivel() {
        return cambiaColorCuadroTextoCuentaNivel;
    }

    public void setCambiaColorCuadroTextoCuentaNivel(Boolean cambiaColorCuadroTextoCuentaNivel) {
        this.cambiaColorCuadroTextoCuentaNivel = cambiaColorCuadroTextoCuentaNivel;
    }

    public Boolean getCambiaColorCuadroTextoCuentaSubNivel() {
        return cambiaColorCuadroTextoCuentaSubNivel;
    }

    public void setCambiaColorCuadroTextoCuentaSubNivel(Boolean cambiaColorCuadroTextoCuentaSubNivel) {
        this.cambiaColorCuadroTextoCuentaSubNivel = cambiaColorCuadroTextoCuentaSubNivel;
    }

    public Boolean getDesactivaNivel() {
        return desactivaNivel;
    }

    public void setDesactivaNivel(Boolean desactivaNivel) {
        this.desactivaNivel = desactivaNivel;
    }

    public Boolean getDesactivaSubNivel() {
        return desactivaSubNivel;
    }

    public void setDesactivaSubNivel(Boolean desactivaSubNivel) {
        this.desactivaSubNivel = desactivaSubNivel;
    }

    public void igualavalorRetencionGrossing(ValueChangeEvent e) {
        grossingUp = retencion;
    }

    public void igualavalorGrossingRetencion(ValueChangeEvent e) {
        retencion = grossingUp;
    }
    ...
    public void setListaCuentasGenerales(List<ParCuentasGenerales> listaCuentasGenerales) {
        this.listaCuentasGenerales = listaCuentasGenerales;
    }

    public Boolean getHabilitaCentroDeCostoNivel3() {
        return habilitaCentroDeCostoNivel3;
    }

    public void setHabilitaCentroDeCostoNivel3(Boolean habilitaCentroDeCostoNivel3) {
        this.habilitaCentroDeCostoNivel3 = habilitaCentroDeCostoNivel3;
    }
