...
@ManagedBean(name = "cntReporteEERRBacking")
@ViewScoped
public class CntReporteEERRBacking extends AbstractManagedBean implements Serializable {
    ...
    public CntReporteEERRBacking() {
    }

    @PostConstruct
    void initcntReporteEERRBacking() {
    ...
    public List<PojoCntEntidadBGyEERR> listaDetallesComprobantesPorConsulta() throws Exception {
        ...
        if (fechaHasta != null) {
            ...
            listaResultadoConsulta = cntDetalleComprobanteService.listPlanCuentaParaBGyEERR(fechaHasta, "EERR");
